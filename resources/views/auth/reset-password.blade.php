...
<div class="min-h-screen bg-gradient-to-br from-brand-50 via-red-50 to-rose-100 flex flex-col items-center justify-center py-12 px-4">
    ...
    {{-- Heading --}}
    <h1 class="text-2xl font-bold text-gray-900 mb-1">Atur Ulang Password</h1>
    <p class="text-gray-500 text-sm mb-8">Masukkan password baru untuk akun Anda</p>

    {{-- Card --}}
    <div class="w-full max-w-md bg-white rounded-2xl shadow-md px-8 py-8">

        {{-- Session Error (mis. token invalid/kedaluwarsa) --}}
        @if (session('error'))

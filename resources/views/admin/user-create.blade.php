        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6">
            <div class="flex items-start justify-between gap-4 flex-wrap">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Buat akun pegawai atau admin baru secara manual.</p>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="nip" value="{{ old('nip') }}" placeholder="Boleh dikosongkan"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="nama@brin.go.id"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="institusi" value="{{ old('institusi', 'BRIN') }}"
                ...
                <div>
                    ...
                    <select name="pusat_riset"
                        ...
                        @foreach ($pusatRiset as $pr)
                            <option value="{{ $pr }}" {{ old('pusat_riset') === $pr ? 'selected' : '' }}>{{ $pr }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="role"
                        class="w-full h-11 px-4 rounded-xl border @error('role') border-red-400 bg-red-50 @else border-gray-300 @enderror text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-700 mb-1.5">Password <span class="text-brand-600">*</span></p>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
